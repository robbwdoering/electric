...
- [local-stack](local-stack/) &mdash; Docker Compose stack to run the backend services locally
- [protocol/satellite.proto](protocol/satellite.proto) &mdash; Protocol Buffers definition of the Satellite replication protocol
- [examples](examples/) &mdash; A collection of example apps.
