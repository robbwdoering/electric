defmodule Electric.Satellite.SerializationTest do
  ...
  describe "map_to_row" do
    test "encodes a map into a SatOpRow struct" do
      ...
      assert %SatOpRow{
               values: ["", "", "4", uuid, "13", "...", "-3.14", <<0xFF, 0xA0, 0x01>>],
               nulls_bitmask: <<0b11000000>>
             } == Serialization.map_to_row(data, columns)
    end

    # TODO: move this to LogicalReplicationProducerTest
    # test "extends the time zone offset for values of timestamptz type" do
    #   data = %{
    #     "t1" => "2023-08-14 10:01:28.848242-04",
    #     "t2" => "2023-08-14 10:01:28+00",
    #     "t3" => "2023-08-14 00:00:00.123+05:30"
    #   }
    ...
    #              "2023-08-14 10:01:28+00:00",
    #              "2023-08-14 00:00:00.123+05:30"
    #            ],
    #            nulls_bitmask: <<0>>
    #          } == Serialization.map_to_row(data, columns)
    # end
  ...
  describe "decode_record" do
    test "decodes a SatOpRow struct into a map" do
      row = %SatOpRow{
        nulls_bitmask: <<0b00100001, 0b00000000>>,
        values: [
          "256",
          "hello",
          "",
